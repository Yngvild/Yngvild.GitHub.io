...
\hypersetup{
  ...
  pdfauthor={Yngvild Vindenes (yngvild.vindenes@ibv.uio.no)},
  hidelinks,
...
\NormalTok{songbird.lifetable }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"x"} \OtherTok{=}\NormalTok{ x, }\StringTok{"lx"}\OtherTok{=}\NormalTok{lx, }\StringTok{"px"}\OtherTok{=}\NormalTok{px, }
                                 \StringTok{"mx"}\OtherTok{=}\NormalTok{mx, }\StringTok{"lxmx"}\OtherTok{=}\NormalTok{lx}\SpecialCharTok{*}\NormalTok{mx)}

\CommentTok{\#For plotting it is useful to use the long format:}
\NormalTok{songbirds.long }\OtherTok{\textless{}{-}}\NormalTok{ songbird.lifetable }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(lx, px,  mx,lxmx),}
               \AttributeTok{names\_to =} \StringTok{"VitalRates"}\NormalTok{, }\AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}
\NormalTok{ songbirds.long}\SpecialCharTok{$}\NormalTok{VitalRates }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{( songbirds.long}\SpecialCharTok{$}\NormalTok{VitalRates,}
                     \AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"px"}\NormalTok{, }\StringTok{"lx"}\NormalTok{ , }\StringTok{"mx"}\NormalTok{, }\StringTok{"lxmx"}\NormalTok{))}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/figbird1-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Rearranging  Euler{-}Lotka function:}
...
\NormalTok{lambdabird }\OtherTok{\textless{}{-}} \FunctionTok{uniroot}\NormalTok{(EulerLotka, }\AttributeTok{x=}\NormalTok{x, }
    \AttributeTok{lx=}\NormalTok{lx, }\AttributeTok{mx=}\NormalTok{mx, }\AttributeTok{interval=}\FunctionTok{c}\NormalTok{(.}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{))}\SpecialCharTok{$}\NormalTok{root}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Pop.bird.long}\SpecialCharTok{$}\NormalTok{census }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(Pop.bird.long}\SpecialCharTok{$}\NormalTok{census, }
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/birdgrowth-1.pdf}
...
\NormalTok{birdframe.asym }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"AgeClass"}\OtherTok{=}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{, }
                             \StringTok{"u"}\OtherTok{=}\NormalTok{u.bird.pre, }
                             \StringTok{"v"}\OtherTok{=}\FunctionTok{t}\NormalTok{(v.bird.bird))}

\CommentTok{\#Long format for plotting:}
\NormalTok{birdframe.asym.long }\OtherTok{\textless{}{-}}\NormalTok{ birdframe.asym }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(u,v),}
               \AttributeTok{names\_to =} \StringTok{"Vector"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}

\CommentTok{\#Ensure order of factor levels (for plotting)}
\NormalTok{birdframe.asym.long}\SpecialCharTok{$}\NormalTok{AgeClass }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(birdframe.asym.long}\SpecialCharTok{$}\NormalTok{AgeClass, }
...
\FunctionTok{ggplot}\NormalTok{(birdframe.asym.long) }\SpecialCharTok{+} 
  \FunctionTok{geom\_col}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{AgeClass, }\AttributeTok{y=}\NormalTok{Value, }
               \AttributeTok{fill=}\NormalTok{AgeClass ), }\AttributeTok{lwd=}\FloatTok{1.2}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/stablerepro-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
 \CommentTok{\#Extract fertility sensitivities:}
\NormalTok{fert.sens }\OtherTok{\textless{}{-}}\NormalTok{ sens.mat.post[}\DecValTok{1}\NormalTok{,]}

\CommentTok{\#Extract survival sensitivities:}
\NormalTok{surv.sens }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(sens.mat.post[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{], }
\NormalTok{               sens.mat.post[}\DecValTok{3}\NormalTok{,}\DecValTok{2}\NormalTok{], }
\NormalTok{               sens.mat.post[}\DecValTok{3}\NormalTok{,}\DecValTok{3}\NormalTok{])  }

\CommentTok{\#Create data frame for plotting}
\NormalTok{birdframe.sens }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"AgeClass"}\OtherTok{=}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{, }
                             \StringTok{"FertilitySensitivity"}\OtherTok{=}\NormalTok{fert.sens, }
                             \StringTok{"SurvivalSensitivity"}\OtherTok{=}\NormalTok{surv.sens)}

\CommentTok{\#Long format for plotting:}
\NormalTok{birdframe.sens.long }\OtherTok{\textless{}{-}}\NormalTok{ birdframe.sens }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\StringTok{"AgeClass"}\NormalTok{),}
               \AttributeTok{names\_to =} \StringTok{"SensitivityTo"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}

\NormalTok{birdframe.sens.long}\SpecialCharTok{$}\NormalTok{AgeClass }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(birdframe.sens.long}\SpecialCharTok{$}\NormalTok{AgeClass,}
                                       \AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{))}
\CommentTok{\#Plot}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/sensitivitybird1-1.pdf}
...
\CommentTok{\#Fecundity sensitivities m0{-}m1{-}m2{-}m3:}
\NormalTok{m.sens }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }
            \DecValTok{0}\NormalTok{, }
\NormalTok{            v[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{*}\NormalTok{u[}\DecValTok{2}\NormalTok{]}\SpecialCharTok{*}\NormalTok{px[}\DecValTok{2}\NormalTok{], }
\NormalTok{            v[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{*}\NormalTok{u[}\DecValTok{3}\NormalTok{]}\SpecialCharTok{*}\NormalTok{px[}\DecValTok{3}\NormalTok{]) }

\CommentTok{\#Survival sensitivities p0{-}p1{-}p2{-}p3}
\NormalTok{p.sens }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(v[}\DecValTok{2}\NormalTok{]}\SpecialCharTok{*}\NormalTok{u[}\DecValTok{1}\NormalTok{], }
\NormalTok{            v[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{*}\NormalTok{u[}\DecValTok{2}\NormalTok{]}\SpecialCharTok{*}\NormalTok{mx[}\DecValTok{3}\NormalTok{]}\SpecialCharTok{+}\NormalTok{v[}\DecValTok{3}\NormalTok{]}\SpecialCharTok{*}\NormalTok{u[}\DecValTok{2}\NormalTok{], }
\NormalTok{            v[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{*}\NormalTok{u[}\DecValTok{3}\NormalTok{]}\SpecialCharTok{*}\NormalTok{mx[}\DecValTok{4}\NormalTok{], }
            \DecValTok{0}\NormalTok{)}

\NormalTok{sens.table.bird }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"Age"}\OtherTok{=}\DecValTok{0}\SpecialCharTok{:}\DecValTok{3}\NormalTok{, }
                              \StringTok{"mSensitivity"}\OtherTok{=}\NormalTok{m.sens, }
                              \StringTok{"pSensitivity"}\OtherTok{=}\NormalTok{p.sens)}


\CommentTok{\#Long format for plotting:}
\NormalTok{sens.table.bird.long }\OtherTok{\textless{}{-}}\NormalTok{ sens.table.bird }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\StringTok{"Age"}\NormalTok{),}
               \AttributeTok{names\_to =} \StringTok{"SensitivityTo"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}

\NormalTok{sens.table.bird.long}\SpecialCharTok{$}\NormalTok{Age}\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(sens.table.bird.long}\SpecialCharTok{$}\NormalTok{Age, }
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/sensitivitybird2-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Fecundity elasticities m0{-}m1{-}m2{-}m3:}
\NormalTok{m.elas }\OtherTok{\textless{}{-}}\NormalTok{ mx}\SpecialCharTok{/}\NormalTok{lambda.bird.post}\SpecialCharTok{*}\NormalTok{m.sens }

\CommentTok{\#Survival elasticities p0{-}p1{-}p2{-}p3}
\NormalTok{p.elas }\OtherTok{\textless{}{-}}\NormalTok{ px}\SpecialCharTok{/}\NormalTok{lambda.bird.post}\SpecialCharTok{*}\NormalTok{p.sens }
 
\NormalTok{elas.table.bird }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"Age"}\OtherTok{=}\DecValTok{0}\SpecialCharTok{:}\DecValTok{3}\NormalTok{,}
                              \StringTok{"mElasticity"}\OtherTok{=}\NormalTok{m.elas, }
                              \StringTok{"pElasticity"}\OtherTok{=}\NormalTok{p.elas)}

\CommentTok{\#Long format for plotting:}
\NormalTok{elas.table.bird.long }\OtherTok{\textless{}{-}}\NormalTok{ elas.table.bird }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\StringTok{"Age"}\NormalTok{),}
               \AttributeTok{names\_to =} \StringTok{"ElasticityTo"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}

\NormalTok{elas.table.bird.long}\SpecialCharTok{$}\NormalTok{Age}\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(elas.table.bird.long}\SpecialCharTok{$}\NormalTok{Age, }
                                  \AttributeTok{levels=}\DecValTok{0}\SpecialCharTok{:}\DecValTok{3}\NormalTok{)}
\CommentTok{\#Plot}
\FunctionTok{ggplot}\NormalTok{(elas.table.bird.long) }\SpecialCharTok{+} 
  ...
  \FunctionTok{scale\_fill\_manual}\NormalTok{(}\AttributeTok{values=}\NormalTok{colors4)}\SpecialCharTok{+}  
  \FunctionTok{labs}\NormalTok{( }\AttributeTok{x=}\StringTok{"Age (years)"}\NormalTok{, }\AttributeTok{y=}\StringTok{"Elasticity"}\NormalTok{)}\SpecialCharTok{+}  
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/elasticitybird-1.pdf}
...
\CommentTok{\#Survival gradient:}
\NormalTok{dr.dp }\OtherTok{\textless{}{-}} \FunctionTok{rev}\NormalTok{(}\FunctionTok{cumsum}\NormalTok{(}\FunctionTok{rev}\NormalTok{(}\FunctionTok{exp}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{r}\SpecialCharTok{*}\NormalTok{x)}\SpecialCharTok{*}\NormalTok{lx}\SpecialCharTok{*}\NormalTok{mx)))}\SpecialCharTok{/}\NormalTok{TC\_Bird }

\CommentTok{\#Fecundity gradient:}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/birdgradients-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Reference matrix:}
\NormalTok{AmatBirdR }\OtherTok{\textless{}{-}}\NormalTok{  Abird.pre }

\CommentTok{\#Define treatment matrix:}
\NormalTok{AmatBirdM }\OtherTok{\textless{}{-}} \FunctionTok{Create.Amat}\NormalTok{(}\AttributeTok{Svec=}\FunctionTok{c}\NormalTok{(.}\DecValTok{8}\NormalTok{,.}\DecValTok{5}\NormalTok{,.}\DecValTok{0}\NormalTok{), }\AttributeTok{Fvec=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{5}\NormalTok{,}\DecValTok{1}\NormalTok{ ))  }

\CommentTok{\#Lambda in reference environment:}
\NormalTok{lambdaR}\OtherTok{\textless{}{-}} \FunctionTok{uvlambda}\NormalTok{(AmatBirdR)}\SpecialCharTok{$}\NormalTok{lam}

\CommentTok{\#Lambda in treatment environment}
\NormalTok{lambdaM }\OtherTok{\textless{}{-}} \FunctionTok{uvlambda}\NormalTok{(AmatBirdM)}\SpecialCharTok{$}\NormalTok{lam }

\CommentTok{\#Difference in lambda:}
\NormalTok{lamDiff }\OtherTok{\textless{}{-}}\NormalTok{ lambdaM}\SpecialCharTok{{-}}\NormalTok{lambdaR}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/birdLTRE-1.pdf}
...
\NormalTok{gulls\_table }\OtherTok{\textless{}{-}}\NormalTok{ gulls\_table }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{rowwise}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{lambda=}\FunctionTok{lambdagulls}\NormalTok{(p,q))  }
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/gullfig-1.pdf}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/Lewontin-1.pdf}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/Lewontin2-1.pdf}
...
\NormalTok{Percentiles1  }\OtherTok{\textless{}{-}} \FunctionTok{t}\NormalTok{(}\FunctionTok{apply}\NormalTok{(}\FunctionTok{t}\NormalTok{(simLC\_Large[,}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]), }
...
\NormalTok{LCPercentiles }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(}\StringTok{"Time"}\OtherTok{=}\DecValTok{0}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{dim}\NormalTok{(Percentiles1)[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{),}
...
\NormalTok{LCPercentiles.long}\SpecialCharTok{$}\NormalTok{Percentile }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(}
\NormalTok{  LCPercentiles.long}\SpecialCharTok{$}\NormalTok{Percentile, }
  \AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"5\%"}\NormalTok{, }\StringTok{"25\%"}\NormalTok{, }\StringTok{"50\%"}\NormalTok{, }\StringTok{"75\%"}\NormalTok{, }\StringTok{"95\%"}\NormalTok{,}\StringTok{"Mean"}\NormalTok{))}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/Lewontin3-1.pdf}
...
\FunctionTok{ggplot}\NormalTok{(GetMeans) }\SpecialCharTok{+} 
  ...
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept=}\NormalTok{ Geometric,}\AttributeTok{lwd=}\FloatTok{1.2}\NormalTok{, }
             \AttributeTok{linetype=}\DecValTok{2}\NormalTok{,}\AttributeTok{col=}\DecValTok{2}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{geom\_text}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\DecValTok{10}\NormalTok{, Geometric, }
                \AttributeTok{label =} \StringTok{"Geometric mean"}\NormalTok{, }
                \AttributeTok{vjust=}\DecValTok{2}\NormalTok{), }\AttributeTok{col=}\DecValTok{2}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept=}\NormalTok{Arithmetic,}\AttributeTok{lwd=}\FloatTok{1.2}\NormalTok{,}
             \AttributeTok{col=}\DecValTok{4}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{geom\_text}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\DecValTok{10}\NormalTok{,  Arithmetic, }
                \AttributeTok{label =} \StringTok{"Arithmetic mean"}\NormalTok{, }
                \AttributeTok{vjust=}\SpecialCharTok{{-}}\DecValTok{2}\NormalTok{),}\AttributeTok{col=}\DecValTok{4}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"none"}\NormalTok{ )}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{( }\AttributeTok{x=}\StringTok{"Time (year)"}\NormalTok{, }\AttributeTok{y=}\FunctionTok{expression}\NormalTok{(Lambda[t])) }
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/arithmetic-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Amat.array }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(MatA, }
\NormalTok{                       MatU, }
\NormalTok{                       MatF, }
  ...
  \CommentTok{\#Split survival/transition matrix:}
\NormalTok{  SplitU }\OtherTok{\textless{}{-}} \FunctionTok{DecomposeU}\NormalTok{(MatU) }
  \CommentTok{\#Split fertility matrix:}
\NormalTok{  SplitF }\OtherTok{\textless{}{-}} \FunctionTok{DecomposeF}\NormalTok{(MatF) }
   \CommentTok{\#Transition matrix:}
\NormalTok{  Gmat }\OtherTok{\textless{}{-}}\NormalTok{ SplitU}\SpecialCharTok{$}\NormalTok{Gmat}
   \CommentTok{\#Survival vector:}
\NormalTok{  Svec }\OtherTok{\textless{}{-}}\NormalTok{ SplitU}\SpecialCharTok{$}\NormalTok{Survival}
  \CommentTok{\#Define beta (log{-}log link function):}
\NormalTok{  Beta.S }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\FunctionTok{log}\NormalTok{(}\SpecialCharTok{{-}}\FunctionTok{log}\NormalTok{(Svec))}
  \CommentTok{\#Offspring transition matrix:}
\NormalTok{  Qmat }\OtherTok{\textless{}{-}}\NormalTok{ SplitF}\SpecialCharTok{$}\NormalTok{Qmat }
  \CommentTok{\#Fertility vector:}
\NormalTok{  Fvec }\OtherTok{\textless{}{-}}\NormalTok{ SplitF}\SpecialCharTok{$}\NormalTok{Fertility }
  \CommentTok{\#Define beta (log link function):}
\NormalTok{  Beta.F }\OtherTok{\textless{}{-}} \FunctionTok{log}\NormalTok{(Fvec) }
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/birdstochastic1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/birdstochastic2-1.pdf}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/birdstochastic3-1.pdf}
...
\CommentTok{\#Apply function to get 10 0000 realizations (can take some time)}
\NormalTok{simbird\_Large }\OtherTok{\textless{}{-}} \FunctionTok{nsim.stochastic}\NormalTok{(}\AttributeTok{MatA=}\NormalTok{Abird.pre, }
                                 \AttributeTok{MatU=}\NormalTok{Ubird.pre, }
                                 \AttributeTok{MatF=}\NormalTok{Fbird.pre, }
                                 \AttributeTok{VarF=}\FunctionTok{rep}\NormalTok{(}\FloatTok{0.03}\NormalTok{, }\DecValTok{3}\NormalTok{), }
                                 \AttributeTok{VarS=}\FunctionTok{rep}\NormalTok{(}\FloatTok{0.03}\NormalTok{, }\DecValTok{3}\NormalTok{), }
                                 \AttributeTok{tmax=}\DecValTok{20}\NormalTok{, }
                                 \AttributeTok{nsim=}\DecValTok{10000}\NormalTok{, }
                                 \AttributeTok{n0=}\FunctionTok{rep}\NormalTok{(}\DecValTok{10}\NormalTok{,}\DecValTok{3}\NormalTok{))}

\CommentTok{\#Get the 5, 25, 50, 75, and 95 percentiles:}
\NormalTok{Percentiles2  }\OtherTok{\textless{}{-}} \FunctionTok{t}\NormalTok{(}\FunctionTok{apply}\NormalTok{(}\FunctionTok{t}\NormalTok{(simbird\_Large[,}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]),}
                         \DecValTok{2}\NormalTok{, }
\NormalTok{                         quantile, }
                         \AttributeTok{probs=}\FunctionTok{c}\NormalTok{(.}\DecValTok{05}\NormalTok{, .}\DecValTok{25}\NormalTok{, .}\DecValTok{5}\NormalTok{, .}\DecValTok{75}\NormalTok{,.}\DecValTok{95}\NormalTok{)))}
...
\CommentTok{\#Store percentiles in data frame  }
\NormalTok{BirdPercentiles }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(}\StringTok{"Time"}\OtherTok{=}\DecValTok{0}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{dim}\NormalTok{(Percentiles2)[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{),  }
...
\CommentTok{\#Make sure the order of the percentiles is correct}
\NormalTok{BirdPercentiles.long}\SpecialCharTok{$}\NormalTok{Percentile }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(BirdPercentiles.long}\SpecialCharTok{$}\NormalTok{Percentile, }
                    \AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"5\%"}\NormalTok{, }\StringTok{"25\%"}\NormalTok{, }\StringTok{"50\%"}\NormalTok{, }\StringTok{"75\%"}\NormalTok{, }\StringTok{"95\%"}\NormalTok{,}\StringTok{"Mean"}\NormalTok{))}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/Birdstochastic4-1.pdf}
...
\NormalTok{        results}\SpecialCharTok{$}\NormalTok{Popsize[results}\SpecialCharTok{$}\NormalTok{lambda}\SpecialCharTok{==}\NormalTok{lambdavec[i]] }\OtherTok{\textless{}{-}}
          \FunctionTok{Exp.growth}\NormalTok{(}\AttributeTok{lambda=}\NormalTok{lambdavec[i], }
               \AttributeTok{N0=}\DecValTok{10}\NormalTok{,}
               \AttributeTok{Tmax=}\DecValTok{10}\NormalTok{)}
\NormalTok{\}}
...
\FunctionTok{ggplot}\NormalTok{(results) }\SpecialCharTok{+} 
    \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Time, }\AttributeTok{y=}\NormalTok{LogSize, }\AttributeTok{col=}\NormalTok{lambda, }
                  \AttributeTok{group=}\NormalTok{lambda ), }\AttributeTok{lwd=}\FloatTok{1.2}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
    \FunctionTok{scale\_color\_viridis\_c}\NormalTok{()}\SpecialCharTok{+}
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"top"}\NormalTok{ )}\SpecialCharTok{+} 
    \FunctionTok{labs}\NormalTok{( }\AttributeTok{x=}\StringTok{"Time"}\NormalTok{, }\AttributeTok{y=}\FunctionTok{expression}\NormalTok{(}\FunctionTok{ln}\NormalTok{(N)),}
...
\CommentTok{\#round(lambda\_Plant, digits=3)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Rearranging the Euler{-}Lotka function }
\CommentTok{\#to get an expression equal to zero:}
\NormalTok{EulerLotka }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(lambda, x, lx, mx)\{}
  \FunctionTok{sum}\NormalTok{(lambda}\SpecialCharTok{\^{}}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{x)}\SpecialCharTok{*}\NormalTok{lx}\SpecialCharTok{*}\NormalTok{mx)}\SpecialCharTok{{-}}\DecValTok{1}
\NormalTok{\}}
...
\CommentTok{\#Apply uniroot to find lambda, store the result}
\NormalTok{lambda\_Plant2 }\OtherTok{\textless{}{-}} \FunctionTok{uniroot}\NormalTok{(EulerLotka, }
                         \AttributeTok{x=}\NormalTok{PlantTable}\SpecialCharTok{$}\NormalTok{x, }
                         \AttributeTok{lx=}\NormalTok{PlantTable}\SpecialCharTok{$}\NormalTok{lx, }
                         \AttributeTok{mx=}\NormalTok{PlantTable}\SpecialCharTok{$}\NormalTok{mx,}
                         \AttributeTok{interval=}\NormalTok{lambda.range)}\SpecialCharTok{$}\NormalTok{root}

\CommentTok{\#round(lambda\_Plant2, digits=3)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fertility.plant }\OtherTok{\textless{}{-}}\NormalTok{ px[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{*}\NormalTok{mx[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{5}\NormalTok{] }
\NormalTok{survival.plant }\OtherTok{\textless{}{-}}\NormalTok{ px[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{5}\NormalTok{] }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{R0.plant }\OtherTok{\textless{}{-}} \FunctionTok{R0function}\NormalTok{(UmatPlant, }
\NormalTok{                       FmatPlant)}\SpecialCharTok{$}\NormalTok{R0}
\NormalTok{G.plant }\OtherTok{\textless{}{-}} \FunctionTok{GenTime}\NormalTok{(AmatPlant, }
\NormalTok{                   FmatPlant)}

\NormalTok{ResVec }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(lambda.plant, }
\NormalTok{            R0.plant, }
\NormalTok{            G.plant) }
...
\begin{Highlighting}[]
\CommentTok{\#Create data frame for plotting}
\NormalTok{plantframe }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"AgeClass"}\OtherTok{=}\FunctionTok{factor}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{), }
                         \StringTok{"u"}\OtherTok{=}\NormalTok{res.plant}\SpecialCharTok{$}\NormalTok{u, }
                         \StringTok{"v"}\OtherTok{=}\FunctionTok{t}\NormalTok{(res.plant}\SpecialCharTok{$}\NormalTok{v))}

\CommentTok{\#Long format for plotting:}
\NormalTok{plantframe.long }\OtherTok{\textless{}{-}}\NormalTok{ plantframe }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(u,v),}
               \AttributeTok{names\_to =} \StringTok{"Vector"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}
...
\FunctionTok{ggplot}\NormalTok{(plantframe.long) }\SpecialCharTok{+} 
  \FunctionTok{geom\_col}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{AgeClass, }\AttributeTok{y=}\NormalTok{Value, }
               \AttributeTok{fill=}\NormalTok{AgeClass ), }\AttributeTok{lwd=}\FloatTok{1.2}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\FunctionTok{vars}\NormalTok{(Vector),}\AttributeTok{ncol=}\DecValTok{2}\NormalTok{,}
             \AttributeTok{scales=}\StringTok{"free"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{scale\_fill\_manual}\NormalTok{(}\AttributeTok{values=}\NormalTok{colors4)}\SpecialCharTok{+} 
  \FunctionTok{labs}\NormalTok{( }\AttributeTok{x=}\StringTok{"Age class"}\NormalTok{, }\AttributeTok{y=}\StringTok{"Value"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"none"}\NormalTok{ ) }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{AmatPlantNew }\OtherTok{\textless{}{-}} \FunctionTok{Create.Amat}\NormalTok{(}\AttributeTok{Svec=}\NormalTok{px[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{5}\NormalTok{], }
                            \AttributeTok{Fvec=}\NormalTok{px[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{*}\NormalTok{mx[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{5}\NormalTok{]}\SpecialCharTok{*}\NormalTok{C)}
\NormalTok{FmatPlantNew }\OtherTok{\textless{}{-}}\NormalTok{ UmatPlantNew }\OtherTok{\textless{}{-}}\NormalTok{ AmatPlantNew}

\NormalTok{FmatPlantNew[}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{,] }\OtherTok{\textless{}{-}} \DecValTok{0} 
\NormalTok{UmatPlantNew[}\DecValTok{1}\NormalTok{,] }\OtherTok{\textless{}{-}} \DecValTok{0} 
...
\NormalTok{R0.plantNew }\OtherTok{\textless{}{-}} \FunctionTok{R0function}\NormalTok{(UmatPlantNew, }
\NormalTok{                          FmatPlantNew)}\SpecialCharTok{$}\NormalTok{R0}
\NormalTok{G.plantNew }\OtherTok{\textless{}{-}} \FunctionTok{GenTime}\NormalTok{(AmatPlantNew, }
\NormalTok{                      FmatPlantNew)}

\NormalTok{ResVecNew }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(lambda.plantNew,}
\NormalTok{               R0.plantNew, }
\NormalTok{               G.plantNew)  }
...
\begin{Highlighting}[]
\CommentTok{\#Create data frame for plotting}
\NormalTok{plantframeNew }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"AgeClass"}\OtherTok{=}\FunctionTok{factor}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{), }
                            \StringTok{"u"}\OtherTok{=}\NormalTok{res.plantNew}\SpecialCharTok{$}\NormalTok{u,}
                            \StringTok{"v"}\OtherTok{=}\FunctionTok{t}\NormalTok{(res.plantNew}\SpecialCharTok{$}\NormalTok{v))}

\CommentTok{\#Long format for plotting:}
\NormalTok{plantframeNew.long }\OtherTok{\textless{}{-}}\NormalTok{ plantframeNew }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(u,v),}
               \AttributeTok{names\_to =} \StringTok{"Vector"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}
...
\NormalTok{AmatPlantNew2 }\OtherTok{\textless{}{-}} \FunctionTok{Create.Amat}\NormalTok{(}\AttributeTok{Svec=}\NormalTok{px[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{5}\NormalTok{]}\SpecialCharTok{*}\NormalTok{C, }
                             \AttributeTok{Fvec=}\NormalTok{px[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{*}\NormalTok{mx[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{5}\NormalTok{]}\SpecialCharTok{*}\NormalTok{C)}
\NormalTok{FmatPlantNew2 }\OtherTok{\textless{}{-}}\NormalTok{ UmatPlantNew2 }\OtherTok{\textless{}{-}}\NormalTok{ AmatPlantNew2}

\NormalTok{FmatPlantNew2[}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{,] }\OtherTok{\textless{}{-}} \DecValTok{0} 
\NormalTok{UmatPlantNew2[}\DecValTok{1}\NormalTok{,] }\OtherTok{\textless{}{-}} \DecValTok{0} 
...
\NormalTok{R0.plant.post }\OtherTok{\textless{}{-}} \FunctionTok{R0function}\NormalTok{(UmatPlant.post, }
\NormalTok{                            FmatPlant.post)}\SpecialCharTok{$}\NormalTok{R0}
\NormalTok{G.plant.post }\OtherTok{\textless{}{-}} \FunctionTok{GenTime}\NormalTok{(AmatPlant.post, }
\NormalTok{                        FmatPlant.post)}

\NormalTok{ResVec.post }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(lambda.plant.post,}
\NormalTok{                 R0.plant.post, }
\NormalTok{                 G.plant.post) }\CommentTok{\#Store results}
...
\begin{Highlighting}[]
\CommentTok{\#Create data frame for plotting}
\NormalTok{plantframe.post }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"AgeClass"}\OtherTok{=}\FunctionTok{factor}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{), }
                              \StringTok{"u"}\OtherTok{=}\NormalTok{res.plant.post}\SpecialCharTok{$}\NormalTok{u, }
                              \StringTok{"v"}\OtherTok{=}\FunctionTok{t}\NormalTok{(res.plant.post}\SpecialCharTok{$}\NormalTok{v))}

\CommentTok{\#Long format for plotting:}
\NormalTok{plantframe.post.long }\OtherTok{\textless{}{-}}\NormalTok{ plantframe.post }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(u,v),}
               \AttributeTok{names\_to =} \StringTok{"Vector"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Updated through trial and error :}
\NormalTok{C }\OtherTok{\textless{}{-}} \DecValTok{8}  
\NormalTok{AmatPlantNew.post }\OtherTok{\textless{}{-}} \FunctionTok{Create.Amat}\NormalTok{(}
  \AttributeTok{Svec=} \FunctionTok{c}\NormalTok{(px[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{],}\DecValTok{0}\NormalTok{), }
  \AttributeTok{Fvec=}\NormalTok{px[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{]}\SpecialCharTok{*}\NormalTok{mx[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{5}\NormalTok{]}\SpecialCharTok{*}\NormalTok{C)}

\NormalTok{FmatPlantNew.post }\OtherTok{\textless{}{-}} 
\NormalTok{  UmatPlantNew.post }\OtherTok{\textless{}{-}}\NormalTok{ AmatPlantNew.post}

\NormalTok{FmatPlantNew.post[}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{,] }\OtherTok{\textless{}{-}} \DecValTok{0} 
\NormalTok{UmatPlantNew.post[}\DecValTok{1}\NormalTok{,] }\OtherTok{\textless{}{-}} \DecValTok{0}
...
\NormalTok{R0.plantNew.post }\OtherTok{\textless{}{-}} \FunctionTok{R0function}\NormalTok{(UmatPlantNew.post, }
\NormalTok{                               FmatPlantNew.post)}\SpecialCharTok{$}\NormalTok{R0}
\NormalTok{G.plantNew.post }\OtherTok{\textless{}{-}} \FunctionTok{GenTime}\NormalTok{(AmatPlantNew.post, }
\NormalTok{                           FmatPlantNew.post)}

\NormalTok{ResVecNew.post }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(lambda.plantNew.post, }
\NormalTok{                    R0.plantNew.post, }
\NormalTok{                    G.plantNew.post)  }
...
\begin{Highlighting}[]
\CommentTok{\#Create data frame for plotting}
\NormalTok{plantframeNew.post }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"AgeClass"}\OtherTok{=}\FunctionTok{factor}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{), }
             \StringTok{"u"}\OtherTok{=}\NormalTok{res.plantNew.post}\SpecialCharTok{$}\NormalTok{u, }
             \StringTok{"v"}\OtherTok{=}\FunctionTok{t}\NormalTok{(res.plantNew.post}\SpecialCharTok{$}\NormalTok{v))}

\CommentTok{\#Long format for plotting:}
\NormalTok{plantframeNew.post.long }\OtherTok{\textless{}{-}}\NormalTok{ plantframeNew.post }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(u,v),}
               \AttributeTok{names\_to =} \StringTok{"Vector"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}
...
\FunctionTok{ggplot}\NormalTok{(plantframeNew.post.long) }\SpecialCharTok{+} 
  ...
  \FunctionTok{facet\_wrap}\NormalTok{(}\FunctionTok{vars}\NormalTok{(Vector),}\AttributeTok{ncol=}\DecValTok{2}\NormalTok{,}
             \AttributeTok{scales=}\StringTok{"free"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{scale\_fill\_manual}\NormalTok{(}\AttributeTok{values=}\NormalTok{colors4) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
  \FunctionTok{labs}\NormalTok{( }\AttributeTok{x=}\StringTok{"Age class"}\NormalTok{, }\AttributeTok{y=}\StringTok{"Value"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\#Updated through trial and error :}
\NormalTok{C }\OtherTok{\textless{}{-}} \FloatTok{1.8} 
\NormalTok{AmatPlantNew2.post }\OtherTok{\textless{}{-}} \FunctionTok{Create.Amat}\NormalTok{(}
  \AttributeTok{Svec=} \FunctionTok{c}\NormalTok{(px[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{],}\DecValTok{0}\NormalTok{)}\SpecialCharTok{*}\NormalTok{C,}
  \AttributeTok{Fvec=}\NormalTok{px[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{]}\SpecialCharTok{*}\NormalTok{mx[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{5}\NormalTok{]}\SpecialCharTok{*}\NormalTok{C)}

\NormalTok{FmatPlantNew2.post }\OtherTok{\textless{}{-}} 
\NormalTok{  UmatPlantNew2.post }\OtherTok{\textless{}{-}}\NormalTok{ AmatPlantNew2.post}

\NormalTok{FmatPlantNew2.post[}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{,] }\OtherTok{\textless{}{-}} \DecValTok{0} 
\NormalTok{UmatPlantNew2.post[}\DecValTok{1}\NormalTok{,] }\OtherTok{\textless{}{-}} \DecValTok{0}  
...
\NormalTok{frame.isopod }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"Stage"}\OtherTok{=}\FunctionTok{as.factor}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{7}\NormalTok{),}
                           \StringTok{"Survival"}\OtherTok{=}\NormalTok{Svec.isopod,}
                           \StringTok{"Fertility"}\OtherTok{=}\NormalTok{Fvec.isopod)}

\CommentTok{\#Long format:}
\NormalTok{frame.isopod.long }\OtherTok{\textless{}{-}}\NormalTok{ frame.isopod }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(Survival, Fertility), }
               \AttributeTok{names\_to =} \StringTok{"VitalRates"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}
...
\FunctionTok{ggplot}\NormalTok{(frame.isopod.long) }\SpecialCharTok{+} 
  ...
  \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\FunctionTok{factor}\NormalTok{(VitalRates,}
                     \AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"Survival"}\NormalTok{, }\StringTok{"Fertility"}\NormalTok{)), }
             \AttributeTok{scales=}\StringTok{"free"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
...
\CommentTok{\#Make a data frame for plotting:}
\NormalTok{resframe.isopod }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"Stage"}\OtherTok{=}\FunctionTok{as.factor}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{7}\NormalTok{),}
                              \StringTok{"u"}\OtherTok{=}\NormalTok{res.isopod}\SpecialCharTok{$}\NormalTok{u, }
                              \StringTok{"v"}\OtherTok{=}\FunctionTok{as.vector}\NormalTok{(res.isopod}\SpecialCharTok{$}\NormalTok{v))}

\CommentTok{\#Long format:}
\NormalTok{resframe.isopod.long }\OtherTok{\textless{}{-}}\NormalTok{ resframe.isopod }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(u, v), }\AttributeTok{names\_to =} \StringTok{"uv"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}
...
\NormalTok{Amat.isopod2 }\OtherTok{\textless{}{-}} \FunctionTok{A.isopod}\NormalTok{(}\AttributeTok{GV=}\FunctionTok{c}\NormalTok{(}\FloatTok{0.722}\NormalTok{, }
                              \FloatTok{0.244}\NormalTok{, }
                              \FloatTok{0.231}\NormalTok{, }
                              \FloatTok{0.788}\NormalTok{, }
                              \FloatTok{0.792}\NormalTok{, }
                              \FloatTok{0.5}\SpecialCharTok{*}\FloatTok{0.664}\NormalTok{,}
                              \DecValTok{0}\NormalTok{))}
...
\CommentTok{\#Make a data frame for plotting:}
\NormalTok{resframe.isopod2 }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"Stage"}\OtherTok{=}\FunctionTok{as.factor}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{7}\NormalTok{), }
                               \StringTok{"u"}\OtherTok{=}\NormalTok{res.isopod2}\SpecialCharTok{$}\NormalTok{u, }
                               \StringTok{"v"}\OtherTok{=}\FunctionTok{as.vector}\NormalTok{(res.isopod2}\SpecialCharTok{$}\NormalTok{v))}

\CommentTok{\#Long format:}
\NormalTok{resframe.isopod.long2 }\OtherTok{\textless{}{-}}\NormalTok{ resframe.isopod2 }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(u, v), }\AttributeTok{names\_to =} \StringTok{"uv"}\NormalTok{,}
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}
...
\begin{Highlighting}[]
\CommentTok{\#Modify element 6 of the G{-}vector, e.g. multiply it by 0.5}
\NormalTok{Amat.isopod3 }\OtherTok{\textless{}{-}} \FunctionTok{A.isopod}\NormalTok{(}\AttributeTok{GV=}\FunctionTok{c}\NormalTok{(}\FloatTok{0.722}\NormalTok{, }
                              \FloatTok{0.244}\NormalTok{, }
                              \FloatTok{0.231}\NormalTok{,}
                              \FloatTok{0.5}\SpecialCharTok{*}\FloatTok{0.788}\NormalTok{ , }
                              \FloatTok{0.792}\NormalTok{,}
                              \FloatTok{0.664}\NormalTok{,}
                              \DecValTok{0}\NormalTok{))}
...
\CommentTok{\#Make a data frame for plotting:}
\NormalTok{resframe.isopod3 }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"Stage"}\OtherTok{=}\FunctionTok{as.factor}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{7}\NormalTok{),}
                               \StringTok{"u"}\OtherTok{=}\NormalTok{res.isopod3}\SpecialCharTok{$}\NormalTok{u, }
                               \StringTok{"v"}\OtherTok{=}\FunctionTok{as.vector}\NormalTok{(res.isopod3}\SpecialCharTok{$}\NormalTok{v))}

\CommentTok{\#Long format:}
\NormalTok{resframe.isopod.long3 }\OtherTok{\textless{}{-}}\NormalTok{ resframe.isopod3 }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(u, v), }
               \AttributeTok{names\_to =} \StringTok{"uv"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}
...
\NormalTok{stochastic.plant }\OtherTok{\textless{}{-}} \FunctionTok{projection.stochastic}\NormalTok{(}
  \AttributeTok{Amats =} \FunctionTok{Amat.array}\NormalTok{(}\AttributeTok{MatA=}\NormalTok{APlant, }
                     \AttributeTok{MatU=}\NormalTok{UPlant, }
                     \AttributeTok{MatF=}\NormalTok{FPlant, }
                     \AttributeTok{tmax=}\DecValTok{30}\NormalTok{, }
                     \AttributeTok{VarF=}\FunctionTok{rep}\NormalTok{(}\FloatTok{0.1}\NormalTok{, }\DecValTok{4}\NormalTok{),}
                     \AttributeTok{VarS=}\FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{4}\NormalTok{)), }
  \AttributeTok{n0=}\FunctionTok{c}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{10}\NormalTok{,}\DecValTok{4}\NormalTok{)))}
...
\NormalTok{stochastic.plant2 }\OtherTok{\textless{}{-}} \FunctionTok{projection.stochastic}\NormalTok{(}
  \AttributeTok{Amats =} \FunctionTok{Amat.array}\NormalTok{(}\AttributeTok{MatA=}\NormalTok{APlant, }
                     \AttributeTok{MatU=}\NormalTok{UPlant, }
                     \AttributeTok{MatF=}\NormalTok{FPlant, }
                     \AttributeTok{tmax=}\DecValTok{30}\NormalTok{, }
                     \AttributeTok{VarF=}\FunctionTok{rep}\NormalTok{(}\FloatTok{0.01}\NormalTok{, }\DecValTok{4}\NormalTok{), }
                     \AttributeTok{VarS=}\FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{4}\NormalTok{)), }
  \AttributeTok{n0=}\FunctionTok{c}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{10}\NormalTok{,}\DecValTok{4}\NormalTok{)))}
...
\CommentTok{\#Long format for plotting:}
\NormalTok{stochastic.plant.long }\OtherTok{\textless{}{-}}\NormalTok{ stochastic.plant }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{time,}\SpecialCharTok{{-}}\NormalTok{varF), }\AttributeTok{names\_to =} \StringTok{"AgeClass"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}

\CommentTok{\#Plot:}
\FunctionTok{ggplot}\NormalTok{(stochastic.plant.long) }\SpecialCharTok{+} 
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{time,  }\AttributeTok{y=}\NormalTok{Value, }
                \AttributeTok{col=}\NormalTok{AgeClass, }\AttributeTok{linetype=}\NormalTok{AgeClass), }\AttributeTok{lwd=}\FloatTok{1.2}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{time, }\AttributeTok{y=}\NormalTok{Value, }
                 \AttributeTok{col=}\NormalTok{AgeClass), }\AttributeTok{size=}\DecValTok{3}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
   \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\FunctionTok{factor}\NormalTok{(varF, }
                      \AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"0.1"}\NormalTok{, }\StringTok{"0.01"}\NormalTok{)))}\SpecialCharTok{+}
  \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values=}\NormalTok{colors4)}\SpecialCharTok{+} 
  \FunctionTok{scale\_linetype\_manual}\NormalTok{(}\AttributeTok{values=}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{)}\SpecialCharTok{+}  
  \FunctionTok{labs}\NormalTok{( }\AttributeTok{x=}\StringTok{"Time (year)"}\NormalTok{, }\AttributeTok{y=}\StringTok{"Age class size"}\NormalTok{)  }\SpecialCharTok{+}
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"top"}\NormalTok{ ) }
...
\NormalTok{stochastic.plant }\OtherTok{\textless{}{-}} \FunctionTok{projection.stochastic}\NormalTok{(}
  \AttributeTok{Amats =} \FunctionTok{Amat.array}\NormalTok{(}\AttributeTok{MatA=}\NormalTok{APlant, }
                     ...
                     \AttributeTok{MatF=}\NormalTok{FPlant, }
                     \AttributeTok{tmax=}\DecValTok{30}\NormalTok{, }
                     \AttributeTok{VarF=}\FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{4}\NormalTok{), }
                     \AttributeTok{VarS=}\FunctionTok{rep}\NormalTok{(}\FloatTok{0.1}\NormalTok{, }\DecValTok{4}\NormalTok{)), }
  \AttributeTok{n0=}\FunctionTok{c}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{10}\NormalTok{,}\DecValTok{4}\NormalTok{)))}
...
\NormalTok{stochastic.plant2 }\OtherTok{\textless{}{-}} \FunctionTok{projection.stochastic}\NormalTok{(}
  \AttributeTok{Amats =} \FunctionTok{Amat.array}\NormalTok{(}\AttributeTok{MatA=}\NormalTok{APlant, }
               ...
               \AttributeTok{tmax=}\DecValTok{30}\NormalTok{, }
               \AttributeTok{VarF=}\FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{4}\NormalTok{), }
               \AttributeTok{VarS=}\FunctionTok{rep}\NormalTok{(}\FloatTok{0.01}\NormalTok{, }\DecValTok{4}\NormalTok{)), }
  \AttributeTok{n0=}\FunctionTok{c}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{10}\NormalTok{,}\DecValTok{4}\NormalTok{)))}
...
\CommentTok{\#Add the two:}
\NormalTok{stochastic.plant }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(stochastic.plant, }
\NormalTok{                          stochastic.plant2) }


\CommentTok{\#Long format for plotting:}
\NormalTok{stochastic.plant.long }\OtherTok{\textless{}{-}}\NormalTok{ stochastic.plant }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{time,}\SpecialCharTok{{-}}\NormalTok{varS),}
               \AttributeTok{names\_to =} \StringTok{"AgeClass"}\NormalTok{, }
               \AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{)}
...
\FunctionTok{ggplot}\NormalTok{(stochastic.plant.long) }\SpecialCharTok{+} 
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{time, }\AttributeTok{y=}\NormalTok{Value, }\AttributeTok{col=}\NormalTok{AgeClass, }
                \AttributeTok{linetype=}\NormalTok{AgeClass), }\AttributeTok{lwd=}\FloatTok{1.2}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{time, }\AttributeTok{y=}\NormalTok{Value, }\AttributeTok{col=}\NormalTok{AgeClass), }
             \AttributeTok{size=}\DecValTok{3}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
   \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\FunctionTok{factor}\NormalTok{(varS, }
                      \AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"0.1"}\NormalTok{, }\StringTok{"0.01"}\NormalTok{)))}\SpecialCharTok{+}
  \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values=}\NormalTok{colors4)}\SpecialCharTok{+} 
  \FunctionTok{scale\_linetype\_manual}\NormalTok{(}\AttributeTok{values=}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{)}\SpecialCharTok{+}  
  \FunctionTok{labs}\NormalTok{( }\AttributeTok{x=}\StringTok{"Time (year)"}\NormalTok{, }\AttributeTok{y=}\StringTok{"Age class size"}\NormalTok{)  }\SpecialCharTok{+}
...
\NormalTok{AmatPoor }\OtherTok{\textless{}{-}} \FunctionTok{Create.Amat}\NormalTok{(}\AttributeTok{Svec=}\FunctionTok{c}\NormalTok{(.}\DecValTok{8}\NormalTok{,}\FunctionTok{rep}\NormalTok{(.}\DecValTok{82}\NormalTok{,}\DecValTok{4}\NormalTok{)),}
                        \AttributeTok{Fvec=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\FloatTok{0.16}\NormalTok{, }\FloatTok{0.2}\NormalTok{, }\FloatTok{0.2}\NormalTok{) )}

\NormalTok{AmatGood }\OtherTok{\textless{}{-}} \FunctionTok{Create.Amat}\NormalTok{(}\AttributeTok{Svec=}\FunctionTok{c}\NormalTok{(.}\DecValTok{8}\NormalTok{,}\FunctionTok{rep}\NormalTok{(.}\DecValTok{82}\NormalTok{,}\DecValTok{4}\NormalTok{)),}
                        \AttributeTok{Fvec=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.096}\NormalTok{, }\FloatTok{0.16}\NormalTok{, }\FloatTok{0.224}\NormalTok{, }\FloatTok{0.32}\NormalTok{)  )}
...
\CommentTok{\#Store percentiles in data frame  }
\NormalTok{GullPercentiles }\OtherTok{\textless{}{-}} 
  \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(}\StringTok{"Time"}\OtherTok{=}\DecValTok{0}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{dim}\NormalTok{(PercentilesGull)[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{),}
\NormalTok{                                       PercentilesGull))}

\NormalTok{GullPercentiles}\SpecialCharTok{$}\NormalTok{Mean }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(}\FunctionTok{t}\NormalTok{(simgull\_Large[,}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]),}
                              \DecValTok{2}\NormalTok{, }
\NormalTok{                              mean)}

\CommentTok{\#Make long format for plotting}
\NormalTok{GullPercentiles.long }\OtherTok{\textless{}{-}}\NormalTok{ GullPercentiles }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Time),}
               \AttributeTok{names\_to =} \StringTok{"Percentile"}\NormalTok{, }\AttributeTok{values\_to =} \StringTok{"N"}\NormalTok{)}

\CommentTok{\#Make sure the order of the percentiles is correct}
\NormalTok{GullPercentiles.long}\SpecialCharTok{$}\NormalTok{Percentile }\OtherTok{\textless{}{-}} 
  \FunctionTok{factor}\NormalTok{(GullPercentiles.long}\SpecialCharTok{$}\NormalTok{Percentile, }
         \AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"5\%"}\NormalTok{, }\StringTok{"25\%"}\NormalTok{, }\StringTok{"50\%"}\NormalTok{, }\StringTok{"75\%"}\NormalTok{, }\StringTok{"95\%"}\NormalTok{,}\StringTok{"Mean"}\NormalTok{))}
...
\CommentTok{\#Get the 5, 25, 50, 75, and 95 percentiles:}
\NormalTok{PercentilesG  }\OtherTok{\textless{}{-}} \FunctionTok{t}\NormalTok{(}\FunctionTok{apply}\NormalTok{(}\FunctionTok{t}\NormalTok{(simgullG[,}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]),}
                         \DecValTok{2}\NormalTok{, }
\NormalTok{                         quantile, }
                         \AttributeTok{probs=}\FunctionTok{c}\NormalTok{(.}\DecValTok{05}\NormalTok{, .}\DecValTok{25}\NormalTok{, .}\DecValTok{5}\NormalTok{, .}\DecValTok{75}\NormalTok{,.}\DecValTok{95}\NormalTok{)))}
\NormalTok{PercentilesP  }\OtherTok{\textless{}{-}} \FunctionTok{t}\NormalTok{(}\FunctionTok{apply}\NormalTok{(}\FunctionTok{t}\NormalTok{(simgullP[,}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]),}
                         \DecValTok{2}\NormalTok{, }
\NormalTok{                         quantile, }
                         \AttributeTok{probs=}\FunctionTok{c}\NormalTok{(.}\DecValTok{05}\NormalTok{, .}\DecValTok{25}\NormalTok{, .}\DecValTok{5}\NormalTok{, .}\DecValTok{75}\NormalTok{,.}\DecValTok{95}\NormalTok{)))}

\CommentTok{\#Store percentiles in data frame  }
\NormalTok{GPercentiles }\OtherTok{\textless{}{-}} 
  \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(}\StringTok{"Time"}\OtherTok{=}\DecValTok{0}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{dim}\NormalTok{(PercentilesG)[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{),  }
\NormalTok{                                    PercentilesG))}
\NormalTok{GPercentiles}\SpecialCharTok{$}\NormalTok{Mean }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(}\FunctionTok{t}\NormalTok{(PercentilesG[,}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]),}
                           \DecValTok{2}\NormalTok{, }
\NormalTok{                           mean)}

\NormalTok{PPercentiles }\OtherTok{\textless{}{-}} 
  \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(}\StringTok{"Time"}\OtherTok{=}\DecValTok{0}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{dim}\NormalTok{(PercentilesP)[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{),  }
\NormalTok{                                    PercentilesP))}
\NormalTok{PPercentiles}\SpecialCharTok{$}\NormalTok{Mean }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(}\FunctionTok{t}\NormalTok{(PercentilesP[,}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]),}
                           \DecValTok{2}\NormalTok{, }
\NormalTok{                           mean)}
...
\CommentTok{\#Make long format for plotting}
\NormalTok{PercentilesBoth.long }\OtherTok{\textless{}{-}}\NormalTok{ PercentilesBoth }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Time,}\SpecialCharTok{{-}}\NormalTok{ProbGood), }
               \AttributeTok{names\_to =} \StringTok{"Percentile"}\NormalTok{, }\AttributeTok{values\_to =} \StringTok{"N"}\NormalTok{)}

\CommentTok{\#Make sure the order of the percentiles is correct}
\NormalTok{PercentilesBoth.long}\SpecialCharTok{$}\NormalTok{Percentile }\OtherTok{\textless{}{-}} 
  \FunctionTok{factor}\NormalTok{(PercentilesBoth.long}\SpecialCharTok{$}\NormalTok{Percentile, }
         \AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"5\%"}\NormalTok{, }\StringTok{"25\%"}\NormalTok{, }\StringTok{"50\%"}\NormalTok{, }\StringTok{"75\%"}\NormalTok{, }\StringTok{"95\%"}\NormalTok{,}\StringTok{"Mean"}\NormalTok{))}
...
\NormalTok{ U }\OtherTok{\textless{}{-}}\NormalTok{ ev}\SpecialCharTok{$}\NormalTok{vectors}
\NormalTok{ V }\OtherTok{\textless{}{-}}\NormalTok{ tev}\SpecialCharTok{$}\NormalTok{vectors}
\NormalTok{ u }\OtherTok{\textless{}{-}} \FunctionTok{as.matrix}\NormalTok{(}\FunctionTok{abs}\NormalTok{(}\FunctionTok{Re}\NormalTok{(U[, lmax]))}\SpecialCharTok{/}
                  \FunctionTok{sum}\NormalTok{(}\FunctionTok{abs}\NormalTok{(}\FunctionTok{Re}\NormalTok{(U[, lmax]))))}
\NormalTok{ u }\OtherTok{\textless{}{-}}\NormalTok{ u}\SpecialCharTok{/}\NormalTok{(}\FunctionTok{sum}\NormalTok{(u)) }\CommentTok{\#scale u}
\NormalTok{ v }\OtherTok{\textless{}{-}} \FunctionTok{as.matrix}\NormalTok{(}\FunctionTok{abs}\NormalTok{(}\FunctionTok{Re}\NormalTok{(V[, lmax])))}
\NormalTok{ v }\OtherTok{\textless{}{-}}\NormalTok{ v}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(u}\SpecialCharTok{*}\NormalTok{v ) }\CommentTok{\#scale v}
\NormalTok{ v }\OtherTok{\textless{}{-}} \FunctionTok{t}\NormalTok{(}\FunctionTok{ifelse}\NormalTok{(u}\SpecialCharTok{*}\NormalTok{v }\SpecialCharTok{\textless{}=} \DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, v))}
 \FunctionTok{return}\NormalTok{(}\FunctionTok{list}\NormalTok{(}\StringTok{"lambda"}\OtherTok{=}\FunctionTok{max}\NormalTok{(}\FunctionTok{Re}\NormalTok{(ev}\SpecialCharTok{$}\NormalTok{values)),}
             \StringTok{"u"}\OtherTok{=}\NormalTok{u,}
             \StringTok{"v"}\OtherTok{=}\NormalTok{v))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\CommentTok{\#Apply uniroot to find lambda }
\CommentTok{\#(EulerLotka defined among funcions)}
\CommentTok{\#{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{lambdabird }\OtherTok{\textless{}{-}} \FunctionTok{uniroot}\NormalTok{(EulerLotka, }
                      \AttributeTok{x=}\NormalTok{x,}
                      \AttributeTok{lx=}\NormalTok{lx,}
                      \AttributeTok{mx=}\NormalTok{mx,}
                      \AttributeTok{interval=}\FunctionTok{c}\NormalTok{(.}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{))}\SpecialCharTok{$}\NormalTok{root}

\CommentTok{\#{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\CommentTok{\#Projection matrices}
\CommentTok{\#{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{Abird.pre }\OtherTok{\textless{}{-}} \FunctionTok{Create.Amat}\NormalTok{(}
\NormalTok{  Svec }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(.}\DecValTok{9}\NormalTok{, .}\DecValTok{6}\NormalTok{, }\DecValTok{0}\NormalTok{), }
  \AttributeTok{Fvec=} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, .}\DecValTok{6}\NormalTok{, }\FloatTok{1.2}\NormalTok{))  }
\NormalTok{Abird.post }\OtherTok{\textless{}{-}} \FunctionTok{Create.Amat}\NormalTok{(}
\NormalTok{  Svec }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(.}\DecValTok{2}\NormalTok{, .}\DecValTok{9}\NormalTok{, }\DecValTok{0}\NormalTok{), }
  \AttributeTok{Fvec=} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{2.7}\NormalTok{, }\FloatTok{3.6}\NormalTok{))  }
